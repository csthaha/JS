...
class Barrage {
    ...
    init() {
        ...
        this.width = p.clientWidth  //获取元素的自身宽度
...
//设置 video 的play 事件 来调用canvasBarrage 里面的render 
video.addEventListener('play',() => {
    canvasBarrage.isPaused = false
    canvasBarrage.render();// 触发弹幕了
